...
- **Order: Intro (5min); Discoveries (10min); Github intro (10-15min), Code Review (5min) and then breakout room with questions**
...
- Sadegh to talk about: Documentation and tools for Github; Matues to elaborate for 2 to 3mins more
- 
## Action Items
