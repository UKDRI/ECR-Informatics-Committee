...
df <-
  readr::read_csv(
    here::here(
      "03_data/001_connectome_2023/2023-10-13_reproducibility-sentiment-analysis.csv"
    ),
...
ggplot(df_long, aes(x = question, y = count, fill = experience)) +
  geom_col(position = "dodge") +
  scale_fill_viridis_d() +  # Use viridis colour palette
  labs(x = "Question", y = "Count", title = "Ordered Plot") +
  theme_bw() +
